...
public class DoWhileSwimming
{
	...
	//Both swimmer, swim for the same amount of time
	//One swimmer swims for a min because the contions were not checked.
	//Galent checks the water, Goofus just dives right in
	//The while loop checks the condition first, do while runs the code once, and then checks the condition. 
